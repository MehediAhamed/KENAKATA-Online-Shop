	...
	<div class="container-fluid" >
		<div class="row justify-content-center">
			<div class="col-sm-3 pt-4">
				<div class="card border border-info" style="background-color: #EEB5D5;">
			...
			<div class="col-sm-3 pt-4">
				<div class="card" style="background-color: #EEDCB5;">
					<div class="card-body text-center">
			...
			<div class="col-sm-3 pt-4">
				<div class="card" style="background-color: #DDB5EE;">
					<div class="card-body text-center">
