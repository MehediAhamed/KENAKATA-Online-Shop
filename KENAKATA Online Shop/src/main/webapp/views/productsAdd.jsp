...
<body style="background-color:#ffffff; color:#00004d">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<ul class="navbar-nav">
					<li class="nav-item active"><a class="nav-link"
						href="/adminhome" style="background-color:	  #ff6666">Home Page</a></li>
					<li class="nav-item active"><a class="nav-link"
						href="/logout" style="background-color:	 #ff6666">Logout</a></li>
	...
	<div class="jumbotron container border border-info"  style="background-color:  #ff6666">
		...
		<form action="sendData" method="post">
			<div class="row">
				...
				<div class="form-group" style="padding:13px 0px 0px 00px">
					...
					<input style="background-color:red;text-align:center" type="submit" class="btn btn-primary" >
