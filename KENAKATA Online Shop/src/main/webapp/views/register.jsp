...
<div class="container d-flex justify-content-center align-items-center" style="">
    <div class="col-sm-6">
        <h3 style="margin-top: 10px" class="text-center">Sign Up Now</h3>
        <p class="text-center">Please fill out this to register</p>
        <form action="newuserregister" method="post">
        
        
        			<div class="form-group">
						<label for="name">Id</label> 
						<input type="number" readonly="readonly" class="form-control border border-danger" name="id"  value="${ pid }">
...
<span style="margin-top: 10px">Already have an account <a class="linkControl text-danger" href="index">Login here</a></span> <br><br>
            <input type="submit" value="Register" class="btn btn-danger btn-block py-3"><br>
